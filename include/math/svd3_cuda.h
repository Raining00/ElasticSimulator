...
template <typename Real>
__host__ __device__ __forceinline__
void condSwap(bool c, Real &X, Real &Y)
{
    // used in step 2
    Real Z = X;
    X = c ? Y : X;
...
template <typename Real>
__host__ __device__ __forceinline__
void condNegSwap(bool c, Real &X, Real &Y)
{
...
__host__ __device__ __forceinline__
void multAB(Real a11, Real a12, Real a13,
...
__host__ __device__ __forceinline__
void multAtB(Real a11, Real a12, Real a13,
          Real a21, Real a22, Real a23,
          Real a31, Real a32, Real a33,
          //
          Real b11, Real b12, Real b13,
...
template <typename Real>
__host__ __device__ __forceinline__
void approximateGivensQuaternion(Real a11, Real a12, Real a22, Real &ch, Real &sh)
{
/*
                        ...
                        Real * qV)
{
    ...
    // make temp copy of S
    Real _s11 = s11;
    Real _s21 = s21; Real _s22 = s22;
    Real _s31 = s31; Real _s32 = s32; Real _s33 = s33;
...
template <typename Real>
__host__ __device__ __forceinline__
Real dist2(Real x, Real y, Real z)
{
    return x*x+y*y+z*z;
}
