...
class Camera:
    def __init__(self):
        ...
        self.upDir = ti.Vector.field(3, dtype=ti.f32, shape=())
        self.left = ti.Vector.field(3, dtype=ti.f32, shape=())
        ...
        self.view_matrix = ti.Matrix.field(4, 4, dtype=ti.f32, shape=())
...
class Floor:
    def __init__(self, height, scale):
        ...
        self.ndc = ti.Vector.field(4, dtype=ti.f32, shape=4)
        self.height = height
        self.scale = scale
